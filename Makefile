...
kvstore_test: kvstore_test.c kvstore.c kvstore.h 
	$(CC) $(CFLAGS) kvstore_test.c -o kvstore_test.o -L../OS-Theory-KeyValueStore -lkvstorelib -lglib-2.0
checkpoint1_test: checkpoint1_test.c kvstore.c kvstore.h
	$(CC) $(CFLAGS) checkpoint1_test.c -o checkpoint1_test.o -L../OS-Theory-KeyValueStore -lkvstorelib -lglib-2.0

checkpoint_userinput1_test: checkpoint_userinput1_test.c kvstore.c kvstore.h
	$(CC) $(CFLAGS) checkpoint_userinput1_test.c -o checkpoint_userinput1_test.o -L../OS-Theory-KeyValueStore -lkvstorelib -lglib-2.0
